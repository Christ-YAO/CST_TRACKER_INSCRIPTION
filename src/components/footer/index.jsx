...
export default function SimpleContainer() {
  return (
    <React.Fragment>
      <Toolbar sx={{p: "50px 10px 15px 10px", display: 'block', width: 'auto', m: '0 auto', bgcolor: "#a53816", color: "#f8f8ff"}}>
        <Box sx={{display: 'flex', justifyContent: 'space-around', flexWrap:'wrap', maxWidth: '100%', width: '80%', m: '0 auto'}}>
          <Box sx={{width: "400px", m: '0 auto',}}>
            <Logo />
            <Typography width='400px' mt="40px !important" mb="40px !important" m="0 auto">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cupiditate voluptates.</Typography>
          </Box>
          <Box className="footer" sx={{flex: '1 1 50%',display: 'flex', justifyContent: 'space-around'}}>
            <Box>
