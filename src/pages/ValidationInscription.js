...
function ValidationInscription() {
    return (
        <Box className="backImg3" bgcolor='#f8f8ff' padding='60px 0px' width='100%' minHeight='100vh' marginTop='-15px !important' margin="0 auto">
          <Logo />
        <Typography variant='h1' color='#ff5722' fontWeight='bolder' sx={{ml:{xl:10, lg:10, md:10, sm:5, xs:5, width: '100%'}}} mt="40px">VALIDATION</Typography>
        <Typewriter />
        <Box 
            sx={{
                display: 'flex', 
